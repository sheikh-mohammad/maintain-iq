/* ==========================================================================
   ...
   Values are injected at deploy time by the deployment build command into
...
if (!window.PROJECT_URL || !window.PUBLISH_KEY || !window.ADMIN_EMAIL) {
  console.error(
    '[config] Missing runtime globals. On Cloudflare Pages, set the PROJECT_URL / PUBLISH_KEY / ADMIN_EMAIL ' +
